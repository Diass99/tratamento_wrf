...
"""
07b-zonal-linhac_out_nov2022.py

Objetivo:
  - Ler arquivos WRF (netCDF4) para os eventos OUT_2021 e NOV_2022 (pulando NOV_2008).
  - Plotar vento zonal em escala de cores e linhas de corrente (streamlines).
  - Salvar as figuras em /home/vinicius/Documentos/tcc/05-ANALISES_REFINAMENTO1/<EVENTO>/WRF_MESO/<dominio>/zonal_linhac/

Uso:
  python 07b-zonal-linhac_out_nov2022.py
"""
...
# SOMENTE os eventos que queremos processar agora (pulando NOV_2008):
EVENTOS    = ["OUT_2021", "NOV_2022"]
...
def main():
        ...
        for dominio in DOMINIOS:
            ...
            for t in range(ntimes):
                for level_hpa in LEVELS_HPA:
                    ...
                    figname = f"zonal_linhac_{level_hpa}hPa_{time_tag}.png"
    ...
    logging.info("=== Fim do script 07b-zonal-linhac_out_nov2022 ===")
